...
Timer0_Init(void){
    ...
    TIMER0_CFG_R = 0x4;         /* 16-bit individual Timer only works with prescaler*/
    TIMER0_TAMR_R = 0x12;        /* Periodic up-counter only works in simulation */
...
//    TIMER0_TAILR_R = 16000 * ttime - 1;  /* Timer A interval load value register*/
    TIMER0_TAILR_R =0x07;
    TIMER0_TAPR_R = 0x1;     /* TimerA Prescaler 16MHz/250=64000Hz */
